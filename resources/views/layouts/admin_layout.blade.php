        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('channels.create')}}" class="nav-link">
                  <p>Добавить канал</p>
                </a>
              </li>
            </ul>
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('advisors.index') }}" class="nav-link">
                            <p>Все рекламодатели</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('advisors.create')}}" class="nav-link">
                            <p>Добавить рекламодателя</p>
                        </a>
                    </li>
                </ul>
            </li>
