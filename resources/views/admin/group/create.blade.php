        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="input-name" placeholder="Введите название группы" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" id="input-enabled" value="{{ TgGroup::STATUS['enabled'] }}" checked="">
                        <label class="form-check-label" for="input-enabled">Активна</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" id="input-disabled" value="{{ TgGroup::STATUS['disabled'] }}">
